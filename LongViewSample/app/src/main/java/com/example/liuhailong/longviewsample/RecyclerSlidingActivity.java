...
import com.example.liuhailong.longviewsample.bean.RowModel;
import com.example.liuhailong.longviewsample.interfaces.OnActivityTouchListener;
import com.example.liuhailong.longviewsample.widget.RecyclerTouchListener;

import java.util.ArrayList;
import java.util.List;

public class RecyclerSlidingActivity extends AppCompatActivity implements RecyclerTouchListener.RecyclerTouchListenerHelper {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.sliding_recycler);
        ...
        onTouchListener
                ...
                .setClickable(new RecyclerTouchListener.OnRowClickListener() {
                    ...
                    public void onRowClicked(int position) {
                        ...
                        Toast.makeText(RecyclerSlidingActivity.this, "Row " + (position + 1) + " clicked!", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onIndependentViewClicked(int independentViewID, int position) {

                        Toast.makeText(RecyclerSlidingActivity.this,"Button in row " + (position + 1) + " clicked!",Toast.LENGTH_SHORT).show();
                    }
                })
                ...
                .setSwipeable(R.id.rowFG, R.id.rowBG, new RecyclerTouchListener.OnSwipeOptionsClickListener() {
                    ...
                    public void onSwipeOptionClicked(int viewID, int position) {
                        ...
                        Toast.makeText(RecyclerSlidingActivity.this,message,Toast.LENGTH_SHORT).show();
                    }
                });
