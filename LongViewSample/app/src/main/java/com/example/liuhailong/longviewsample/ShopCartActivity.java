...
public class ShopCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(ShopCartActivity.this));
    }

    private void initImg() {
        bitmapList.add(BitmapFactory.decodeResource(getResources(), R.mipmap.coin));
        bitmapList.add(BitmapFactory.decodeResource(getResources(), R.mipmap.coin1));
        bitmapList.add(BitmapFactory.decodeResource(getResources(), R.mipmap.coin91));
    }
    ...
    class MyAdapter extends RecyclerView.Adapter<MyVH> {
        ...
        public MyVH onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(ShopCartActivity.this);
            View itemView = inflater.inflate(R.layout.shopcart_item, parent, false);
...
//      一、创造出执行动画的主题---imageview
        ...
        final ImageView goods = new ImageView(ShopCartActivity.this);
...
//        三、正式开始计算动画开始/结束的坐标
        //开始掉落的商品的起始点：商品起始点-父布局起始点+该商品图片的一半 起始点向右侧偏离一段
